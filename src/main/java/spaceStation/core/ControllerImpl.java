...
public class ControllerImpl implements Controller {
    ...
    public String report() {
        ...
        builder.append(String.format(ConstantMessages.REPORT_ASTRONAUT_INFO)).append(System.lineSeparator());
        this.astronautRepository.getModels().forEach(a->{
            ...
            if(a.getBag().getItems().size()==0){
                ...
                builder.append(String.format(ConstantMessages.REPORT_ASTRONAUT_BAG_ITEMS,String.join(ConstantMessages.REPORT_ASTRONAUT_BAG_ITEMS_DELIMITER,items)))
